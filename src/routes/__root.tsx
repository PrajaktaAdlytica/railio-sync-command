...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Railio connects incident response, asset maintenance and crew scheduling into one operational platform for regional rail operators." },
      { property: "og:title", content: "Railio — Coordination infrastructure for regional rail" },
      { property: "og:description", content: "Railio connects incident response, asset maintenance and crew scheduling into one operational platform for regional rail operators." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Railio — Coordination infrastructure for regional rail" },
      { name: "twitter:description", content: "Railio connects incident response, asset maintenance and crew scheduling into one operational platform for regional rail operators." },
